...
.table.table-striped {
  width:100%;
    border-collapse: collapse;
      background: #fff;
    overflow: hidden;
    box-shadow: 0 0px 40px 0px rgba(0, 0, 0, 0.17);
    -moz-box-shadow: 0 0px 40px 0px rgba(0, 0, 0, 0.17);
    -webkit-box-shadow: 0 0px 40px 0px rgba(0, 0, 0, 0.17);
    -o-box-shadow: 0 0px 40px 0px rgba(0, 0, 0, 0.17);
...
<table class="table table-striped">
   ...
   <tbody>
      ...
      <%  String mssg=(String)request.getAttribute("msg"); %>
         <th data-sort="name" colspan="2">Your Detail &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><font color="blue"> <%=(mssg==null)?"":mssg%>
						</font></b></th>
      </tr>
