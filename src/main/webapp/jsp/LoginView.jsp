        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Login</div>
                  <b><font color="blue"> <%=ServletUtility.getErrorMessage(request)%>
                </font></b>
              ...
              <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
                        ...
                        <div  class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control"  maxlength="25" name="login" placeholder="Enter Login Id" style="margin-bottom: 10px" type="text" 
                                value="<%=DataUtility.getStringData(bean.getLogin())%>" />
                           		<font  color="pink"><%=ServletUtility.getErrorMessage("login", request)%></font>
                            </div>
                        </div>
                        ...
                        <div  class="form-group required">
                            ...
                            <div class="controls col-md-8 "> 
                                ...
                                <font
                        color="Blue"> <%=ServletUtility.getErrorMessage("password", request)%></font>
                            </div>
                        </div>
